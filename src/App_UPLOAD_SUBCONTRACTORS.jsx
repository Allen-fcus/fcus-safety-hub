...
function HomeScreen({ go, progress, user, activeProjectId }) {
  ...
  const sections = [
    ...
    { key: "laborlaws", label: t("laborLaws"), desc: t("laborLawsDesc"), icon: ShieldAlert, count: t("alwaysAvailable") },
...
const BASE_GATED_SCREENS = ["forms", "safetyplan", "toolbox", "workplans", "mysubmissions"];
...
export default function SafetyHubPrototype() {
  ...
  const sidebarItems = [
    ...
    { key: "laborlaws", icon: ShieldAlert, label: t("laborLaws") },
  ];
