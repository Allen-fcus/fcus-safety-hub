...
const ALWAYS_PUBLIC_SCREENS = ["emergency", "concern", "laborlaws", "orientationsignin"];
// Normally-gated screens for every project.
const BASE_GATED_SCREENS = ["forms", "hsstandards", "safetyplan", "toolbox", "workplans"];
      ...
      <div className="flex-1 flex flex-col min-h-screen min-w-0">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="md:max-w-3xl md:mx-auto md:w-full">
            ...
            {screen === "hsstandards" && <HSStandardsScreen />}
