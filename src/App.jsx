...
export default function SafetyHubPrototype() {
  ...
  const titles = {
    home: "Safety Hub",
    hsstandards: "H&S Minimum Standards",
    ...
    laborlaws: "TX & Federal Labor Laws",
  ...
  const tabs = [
    ...
    { key: "hsstandards", icon: BookOpen, label: "H&S Std" },
  ...
  const sidebarItems = [
    ...
    { key: "hsstandards", icon: BookOpen, label: "H&S Minimum Standards" },
    { key: "safetyplan", icon: ClipboardCheck, label: "Safety Plan" },
    ...
    { key: "laborlaws", icon: ShieldAlert, label: "TX & Federal Labor Laws" },
  ];
