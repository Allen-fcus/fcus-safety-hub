        ...
        {sections.map((s, i) => (
          <div key={i} className="bg-white rounded-md p-3 border" style={{ borderColor: "#E4E2DA" }}>
            ...
            <div className="flex gap-2">
              <button onClick={() => setViewing(s)} className="flex-1 flex items-center justify-center gap-1 text-[10px] font-bold uppercase px-2 py-1.5 rounded-sm border" style={{ borderColor: "#C9C6BC", color: STEEL, fontFamily: "IBM Plex Mono, monospace" }}>
                <Eye size={12} /> View
              </button>
