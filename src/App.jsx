...
const FORMS_DEFAULT = [
  ...
  },
  {
    ...
    description: "Monthly confirmation that fire protection equipment on-site is in place, accessible, and functional.",
...
const BASE_GATED_SCREENS = ["forms", "safetyplan", "toolbox", "workplans", "mysubmissions", "preconstruction"];
      ...
      <div className="flex-1 flex flex-col min-h-screen min-w-0">
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="md:max-w-3xl md:mx-auto md:w-full">
            ...
            {screen === "forms" && <FormsScreen user={user} go={go} />}
