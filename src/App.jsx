            ...
            {playing.videoLink ? (
              ...
              <div className="aspect-video flex items-center justify-center" style={{ background: INK }}>
                <div className="text-center">
                  ...
                  <div className="text-white/60 text-[11px] mt-2">No video link set for this talk yet.</div>
                </div>
              </div>
            )}
            <div className="p-3">
...
function ToolboxTalkEditor({ talk, user, onDone }) {
  ...
  const submit = async () => {
    ...
    const { data, error: rpcError } = talk
      ? await supabase.rpc("update_toolbox_talk", {
          ...
          p_title: title.trim(), p_length_label: lengthLabel.trim(), p_video_link: videoLink.trim(),
        })
  ...
  return (
    <div className="bg-white rounded-md p-3 border mb-3" style={{ borderColor: "#E4E2DA" }}>
      ...
      <label className="text-[10px] uppercase font-bold" style={{ color: STEEL, fontFamily: "IBM Plex Mono, monospace" }}>Length (e.g. "5 min")</label>
      ...
      <label className="text-[10px] uppercase font-bold" style={{ color: STEEL, fontFamily: "IBM Plex Mono, monospace" }}>Video Link (embeddable URL)</label>
